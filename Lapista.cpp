...
void Lapista::changeposhare(int p) {
	if ((1 < p || p == 1) && (p < 5 || p == 5)) {
...
//
//	}
//	else if ((6 < p || p == 6)&&( p<7 ||p == 7))//resbalon
//	{
//		if (positiontortoise - 6 > 0) {
//			vectortoise[positiontortoise - 1] = 0;
//			positiontortoise -= 6;
//			vectortoise[positionhare - 1] = 1;
//		}
//		else {
//			vectortoise[positiontortoise - 1] = 0;
//			positiontortoise = 1;
...
//		}
//	}
//	else if ((8 < p || p == 8) && (p < 10 || p == 10))//paso lento
//	{
//		vectortoise[positiontortoise - 1] = 0;
//		positiontortoise += 1;
//		vectortoise[positiontortoise - 1] = 1;
